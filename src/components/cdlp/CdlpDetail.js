...
function CdlpDetail(){
    ...
    useEffect(() => {
        dispatch(fetchCdlpDetail(cno))
    }, []);
    const cdlpDetail=useSelector((state)=>state.cdlps.cdlp_detail)
    return(
        <Fragment>
            ...
            <div className={"container"}>
                <div className={"row"}>
                    <div className={"col-md-6"}>
                        <img src={cdlpDetail.poster} alt="Image" className={"img-fluid"}/>
                    </div>
                    <div className={"col-md-6"}>
                        <h2 className={"text-black"}>{cdlpDetail.title}</h2>
                        <br></br>
                        <br></br>
                        <p>이름: {cdlpDetail.name}</p>
                        <p>출판사: {cdlpDetail.pub}</p>
                        <p className={"mb-4"}>종류: {cdlpDetail.type}</p>
                        <p className={"mb-4"}>발매날짜: {cdlpDetail.selldate}</p>
                        <p><strong className={"text-primary h4"}>{cdlpDetail.price} 원</strong></p>
